/**
 * Vision proxy constants for MiMo Copilot.
 *
 * Models that don't support image input (mimo-v2.5-pro, mimo-v2-flash)
 * use a vision-capable proxy model to describe images before forwarding
 * the text description to MiMo.
 */
